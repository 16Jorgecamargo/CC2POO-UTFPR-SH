...
public class LoanRegistrationController {
    ...
    @FXML private Label simulatedAmountLabel;
    @FXML private TableView<Loan> loansTable;
    @FXML private TableColumn<Loan, String> customerColumn;
    @FXML private TableColumn<Loan, Double> amountColumn;
    @FXML private TableColumn<Loan, Double> interestRateColumn;
    @FXML private TableColumn<Loan, String> termColumn;
    @FXML private TableColumn<Loan, Double> totalAmountColumn;
    ...
    public void initialize() {
        ...
        termColumn.setCellValueFactory(data -> 
            new SimpleStringProperty(data.getValue().getTerm() + " " + 
    ...
    private void handleSimulate() {
        if (validateFields()) {
            ...
            simulatedAmountLabel.setText(String.format("R$ %.2f", loan.getTotalAmount()));
        }
    }
